            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li></li>
                        <li><a href="viewitem">viewItems</a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="${pr.base64Image}" width="200" height="50"/>
                        </div>
...
<c:forEach var="pr" items="${prs}">
                        ...
                        <c:forEach var="prsm" items="${pr.images}">
                            <img src="${prsm.image}" width="200" height="50"/>
                        </c:forEach>
...
<c:forEach var="prsm" items="${pr.images}">
      <div class="item">
        <img src="${prsm.image}" alt="Chania" width="460" height="345">
        <div class="carousel-caption">
          <h3>Chania</h3>
          <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
        </div>
