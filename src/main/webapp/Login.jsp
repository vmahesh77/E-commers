...
username<input type="text" name="uname" value=" ${param.uname}" placeholder="username"><br>
pass word<input type="password" name="upassword" placeholder="password"><br>
<input type="hidden" name="cont" value="${param.cont}"><br>
