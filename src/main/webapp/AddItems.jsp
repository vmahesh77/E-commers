...
Item Id:<input type="text" name="id" size="50"/><br>
Item Name:<input type="text" name="name"  size="50"/><br>
Item price:<input type="text" name="price"  size="50"/><br>



Select image<input type="file" name="photo" size="50"/>
