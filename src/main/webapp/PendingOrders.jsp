            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="vieworder">all orders</a></li>
...
<td><a href="AcceptOrders?orderId=<c:out value="${ord.orderId}"></c:out>">accept</a></td>
<td><a href="RejectedOrders?orderId=<c:out value="${ord.orderId}"></c:out>">reject</a></td>
